...
//==============================================================================
void
ToNegativeHarmonyEditor::handleNoteOn(MidiKeyboardState *source,
                                      int midi_channel,
...
void
ToNegativeHarmonyEditor::handleNoteOff(MidiKeyboardState *source,
                                       int midi_channel,
                                       int midi_note_number,
                                       float velocity)
{
...
void
ToNegativeHarmonyEditor::paint(Graphics &g)
{
...
void
ToNegativeHarmonyEditor::resized()
{
